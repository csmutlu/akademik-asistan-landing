...
- Cloudflare Pages için güvenlik/önbellek `_headers`, SPA `_redirects` ve `wrangler.jsonc`; build'lerde AppleDouble (`._*`) temizliği.
...
- Barındırma GitHub Pages'ten **Cloudflare Pages**'e taşındı; `robots.txt` ve site haritası `akademikasistan.com` apex alan adını gösterir.
